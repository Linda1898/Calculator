...
while play == "s":
    ...
    operator_dict1 = ext_calc_module.get_list_of_operators_from_user()
    file_content = ext_calc_module.print_result_and_return_file_content_to_save(list_nums1, list_nums2, operator_dict1)
